...
export function AdminDashboard() {
  ...
  async function saveProduct(formElement: HTMLFormElement, product: Product) {
    const form = new FormData(formElement);
    const payload = {
